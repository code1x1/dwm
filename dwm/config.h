...
static const char *fonts[]          = { "monospace:size=10", "Noto_Color_Emoji:pixelsize=10:antialias=true:autohint=true" };
...
static const Key keys[] = {
	...
	{ 0,                       		XF86XK_AudioMute,      		spawn,          SHCMD("pactl set-sink-mute $(pactl get-default-sink) toggle") },
	{ 0,                       		XF86XK_AudioLowerVolume,    spawn,          SHCMD("pactl set-sink-volume $(pactl get-default-sink) -10%") },
	{ 0,                       		XF86XK_AudioRaiseVolume,    spawn,          SHCMD("pactl set-sink-volume $(pactl get-default-sink) +10%") },
	...
	{ ControlMask,           		XK_space,  					togglekblayout, {0} },
};
